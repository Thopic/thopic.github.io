...
function __wbg_adapter_26(arg0, arg1, arg2) {
    wasm.wasm_bindgen__convert__closures__invoke1_mut__h31b799c0ba683a3f(arg0, arg1, addHeapObject(arg2));
}
...
* @returns {Promise<any>}
*/
export function fetch_file(url) {
    const ptr0 = passStringToWasm0(url, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.fetch_file(ptr0, len0);
...
function __wbg_adapter_88(arg0, arg1, arg2, arg3) {
    wasm.wasm_bindgen__convert__closures__invoke2_mut__h0f6d768d0ffb232d(arg0, arg1, addHeapObject(arg2), addHeapObject(arg3));
}
...
export class ResultJs {
    ...
    static __wrap(ptr) {
        ptr = ptr >>> 0;
        const obj = Object.create(ResultJs.prototype);
        obj.__wbg_ptr = ptr;
    ...
    */
    get n_cdr3() {
        ...
        try {
            ...
            wasm.resultjs_n_cdr3(retptr, this.__wbg_ptr);
    ...
    */
    get aa_cdr3() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_aa_cdr3(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get seq() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_seq(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get full_seq() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_full_seq(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    * @returns {string}
    */
    get reconstructed_seq() {
        let deferred1_0;
        let deferred1_1;
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_reconstructed_seq(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get aligned_v() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_aligned_v(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get aligned_j() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_aligned_j(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get v_name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_v_name(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get j_name() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_j_name(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
    ...
    */
    get pgen() {
        const ret = wasm.resultjs_pgen(this.__wbg_ptr);
        return ret;
    }
    /**
    * @returns {number}
    */
    get likelihood() {
        const ret = wasm.resultjs_likelihood(this.__wbg_ptr);
        return ret;
    }
    /**
    * @returns {number}
    */
    get pos_start_cdr3() {
        const ret = wasm.resultjs_pos_start_cdr3(this.__wbg_ptr);
        return ret >>> 0;
    }
    /**
    * @returns {string}
    */
    get cdr3_pos_string() {
        ...
        try {
            const retptr = wasm.__wbindgen_add_to_stack_pointer(-16);
            wasm.resultjs_cdr3_pos_string(retptr, this.__wbg_ptr);
            var r0 = getInt32Memory0()[retptr / 4 + 0];
            var r1 = getInt32Memory0()[retptr / 4 + 1];
            deferred1_0 = r0;
            deferred1_1 = r1;
...
export class WrappedModel {
    ...
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_wrappedmodel_free(ptr);
    }
    /**
    * Load the default files and set up the necessary objects
    * @returns {Promise<void>}
    */
    static initialize() {
        const ret = wasm.wrappedmodel_initialize();
        return takeObject(ret);
    }
    /**
    ...
    * @returns {Promise<void>}
    */
    static load_model(species, chain) {
        ...
        const ret = wasm.wrappedmodel_load_model(ptr0, len0, ptr1, len1);
        return takeObject(ret);
    }
    /**
    * @param {boolean} functional
    * @returns {Promise<ResultJs>}
    */
    static generate(functional) {
        const ret = wasm.wrappedmodel_generate(functional);
        return takeObject(ret);
    }
    /**
    * @param {string} seq
    ...
    */
    static evaluate(seq) {
        ...
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.wrappedmodel_evaluate(ptr0, len0);
        return takeObject(ret);
    }
    /**
    * @param {string} seq
    ...
    * @returns {Promise<ResultJs>}
    */
    static evaluate_from_cdr3(seq, vname, jname) {
        const ptr0 = passStringToWasm0(seq, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(vname, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ptr2 = passStringToWasm0(jname, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len2 = WASM_VECTOR_LEN;
        const ret = wasm.wrappedmodel_evaluate_from_cdr3(ptr0, len0, ptr1, len1, ptr2, len2);
        return takeObject(ret);
    }
}
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_resultjs_new = function(arg0) {
        const ret = ResultJs.__wrap(arg0);
        return addHeapObject(ret);
    };
    ...
    imports.wbg.__wbg_log_e73e4a740f6ba544 = function(arg0, arg1) {
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('righor_web_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
